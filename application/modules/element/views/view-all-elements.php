...
<div class="content-box"><!-- Start Content Box -->
	...
	<form action="" method="post">
		...
		<table>
			...
			<tbody>
			<?php 
				if(isset($list_tag) && count($list_tag)){
					foreach ($list_tag as $value) {
			?>
				<tr>
					<td><input type="checkbox" name="checkbox[]" value="<?php echo $value['id'] ?>"/></td>
					<td><a href="#" title="tag"><?php echo htmlspecialchars($value['tag']); ?></a></td>
					<td><?php echo $value['parentid']; ?></td>
					<td><?php echo $value['id']; ?></td>
					<td>
					<!-- Icons -->
					<a href="index.php/element/delete/<?php echo $value['id'] ?>?redirect=<?php echo base64_encode(full_url())?>" title="Delete"><img src="template/backend/simpla-admin/resources/images/icons/cross.png" alt="Delete" /></a> 
					<a href="index.php/element/edit/<?php echo $value['id'] ?>?redirect=<?php echo base64_encode(full_url())?>" title="Edit"><img src="template/backend/simpla-admin/resources/images/icons/hammer_screwdriver.png" alt="Edit" /></a>
					</td>
				</tr>
			<?php
					}
