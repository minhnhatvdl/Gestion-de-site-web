...
<div class="content-box"><!-- Start Content Box -->
	...
	<form action="" method="post">
		...
		<table>
			...
			<tbody>
			<?php 
				if(isset($list_page) && count($list_page)){
					foreach ($list_page as $value) {
			?>
				<tr>
					<td><input type="checkbox" name="checkbox[]" value="<?php echo $value['id'] ?>"/></td>
					<td><a href="index.php/page/edit/<?php echo $value['id'] ?>?redirect=<?php echo base64_encode(full_url())?>" title="title"><?php echo htmlspecialchars($value['title']); ?></a></td>
					<td><?php echo $value['link']; ?></td>
					<td><?php echo $value['id']; ?></td>
					<td>
					<!-- Icons -->
					<a href="index.php/page/delete/<?php echo $value['id'] ?>?redirect=<?php echo base64_encode(full_url())?>" title="Delete"><img src="template/backend/simpla-admin/resources/images/icons/cross.png" alt="Delete" /></a> 
					<a href="index.php/page/edit/<?php echo $value['id'] ?>?redirect=<?php echo base64_encode(full_url())?>" title="Edit"><img src="template/backend/simpla-admin/resources/images/icons/hammer_screwdriver.png" alt="Edit" /></a>
					</td>
				</tr>
			<?php
					}
			...
			?>
				<tr><td colspan="5">There is no element.</td></tr>
			<?php
			}
			?>
			</tbody>
