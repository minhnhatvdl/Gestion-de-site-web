	...
	<div class="content-box-content">
		...
		<div class="tab-content default-tab" id="tab2">
			...
			<fieldset> 
				...
				<p>
					<label>Title</label>
					<input id="title" onblur="toUrl(this.value)" class="text-input medium-input" type="text" name="title" value="<?php echo set_value('title', $page['title']); ?>"> 
				...
				<p>
					<label>Link</label>
					<input id="link" onblur="toUrl(this.value)" class="text-input medium-input" type="text" name="link" value="<?php echo set_value('link', $page['link']); ?>">
				...
				<p>
					...
					<form action="" method="post" id="form"> 
						<fieldset> 
							<div class="text-edit"> 
								<textarea style="overflow: scroll;" id="elm1" name="txt_content"><?php echo $page['content']; ?></textarea>
							</div> 
						</fieldset> 
					</form>
				</p>
